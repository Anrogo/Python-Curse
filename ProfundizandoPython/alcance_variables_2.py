# Más sobre funciones anidadas y alcance de variables
...
def funcion_externa():
    ...
    def funcion_anidada():
        ...
        # Debemos especificar nonlocal, para que al intentar cambiarle el valor no lo haga
        # con una copia sino sobre la variable original
